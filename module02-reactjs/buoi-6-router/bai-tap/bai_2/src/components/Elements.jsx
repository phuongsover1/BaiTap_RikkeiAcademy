                  ...
                  <div className='accordion-item'>
                    ...
                    >
                      <div className='accordion-body'>
                        ...
                        skyline of her hometown Bookmarksgrove, the
                        headline of Alphabet Village and the subline
                        of her own road, the Line Lane. Pityful a
                        rethoric question ran over her cheek, then she
                        continued her way.
                      </div>
                    </div>
                  </div>{' '}
          ...
          <div className='container'>
            <div className='row text-center'>
              <div className='col-md-8 mb-3 mb-md-0 mx-auto'>
                <p>
                  Copyright ©. All Rights Reserved. — Designed with
                  love by{' '}
                  <a
